...
The Location Tab works either independently or in conjunction with the
:ref:`LocationRecord`. By creating
Location records, you are presented with the option of using the WEC
Map extension that will generate a Google Map complete with directions
for the location.
...
- **Cal Location, or...:** These options are generated from :ref:`LocationRecords` that you create. If left at None, the displayed location will be generated from the Location field above. If you make a selection here, it will override the above Location field.
