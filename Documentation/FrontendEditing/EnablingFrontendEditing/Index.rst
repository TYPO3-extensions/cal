...
#. Assign the specific rights via TS-Setup – please refer to the chapter :ref:`Rights`.You have extensive control over what gets created, edited, deleted. These options are used to limit the Frontend Calendar Administrator's available options.
