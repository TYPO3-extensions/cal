	...
	function _parseString($value){
		...
		switch ($value){
			...
			case 'next':
				...
				break;
			case 'now':
				array_push($this->stack,array('abs' => time()));
				break;
			case 'today':
				array_push($this->stack,array('today' => time()));
				break;
			case 'tomorrow':
				array_push($this->stack,array('tomorrow' => time()));
				break;
			case 'yesterday':
				array_push($this->stack,array('yesterday' => time()));
				break;
			case 'day':
			case 'days':
