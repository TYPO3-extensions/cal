...
class tx_cal_viewcontroller extends tx_cal_base_controller{
	...
	function drawIcs(&$master_array, $getdate, $sendHeaders=true) {	
		...
		$content = $viewObj->drawIcs($master_array, $getdate, $sendHeaders);
	...
	function drawSearchAllResult(&$master_array, $starttime, $endtime, $searchword, $locationIds) {	
		...
		$content = $viewObj->drawSearchAllResult($master_array, $starttime, $endtime, $searchword, $locationIds);
	 ...
	 *  @return		string		The HTML output of the specified view.
	 */
	function drawSearchEventResult(&$master_array, $starttime, $endtime, $searchword, $locationIds) {	

		/* Call the view and pass it the event to draw */
		$viewObj = $this->getServiceObjByKey('cal_view', 'search', '_searchevent');
		$content = $viewObj->drawSearchEventResult($master_array, $starttime, $endtime, $searchword, $locationIds);
	...
	function drawLocation(&$location) {	
		...
		$content = $viewObj->drawLocation($location);
