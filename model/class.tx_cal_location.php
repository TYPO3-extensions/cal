...
class tx_cal_location extends tx_cal_location_model {
	...
	function renderLocation(){
		...
		$page = $cObj->fileResource($this->conf['view.']['location.']['locationModelTemplate']);
		if ($page=='') {
			return '<h3>calendar: no location model template file found:</h3>'.$this->conf['view.']['location.']['locationModelTemplate'];
		}
