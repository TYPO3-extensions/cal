...
class tx_cal_organizer_partner extends tx_cal_organizer {
	...
	function renderOrganizer(){
		...
		$page = $cObj->fileResource($this->conf['view.']['organizer.']['organizerModelTemplate4Partner']);
		if ($page=='') {
			return '<h3>calendar: no organizer model template file found:</h3>'.$this->conf['view.']['organizer.']['organizerModelTemplate4Partner'];
		}
		$rems = array();
		$sims = array();
		$wrapped = array();
