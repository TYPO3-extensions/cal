...
class tx_cal_phpicalendar_model extends tx_cal_model {
	...
	*/
	...
	function getCalendarTitleMarker(& $template, & $sims, & $rems, $view){
		$sims['###CALENDAR_TITLE###'] = '';
		...
		$sims['###CALENDAR_TITLE###'] = $this->local_cObj->cObjGetSingle($this->conf['view.'][$this->conf['view'].'.']['event.']['calendar_title'], $this->conf['view.'][$this->conf['view'].'.']['event.']['calendar_title.']);
	}
