...
class tx_cal_phpicalendar_model extends tx_cal_model {
	...
	function getLinkToEvent($linktext, $view, $date, $urlOnly = false) {
		...
		if ($this->getEventType () == tx_cal_model::EVENT_TYPE_SHORTCUT || $this->getEventType () == tx_cal_model::EVENT_TYPE_EXTERNAL || $rightsObj->isViewEnabled ($this->getObjectType ()) || $this->conf ['view.'] [$this->getObjectType () . '.'] [$this->getObjectType () . 'ViewPid']) {
			$this->initLocalCObject ($this->getValuesAsArray ());
