 ...
 */
class tx_iCalendar_vevent extends tx_model_iCalendar {
	function getType() {
		return 'vEvent';
	}
...
if (defined ('TYPO3_MODE') && $TYPO3_CONF_VARS [TYPO3_MODE] ['XCLASS'] ['ext/cal/model/iCalendar/class.tx_iCalendar_vevent.php']) {
	include_once ($TYPO3_CONF_VARS [TYPO3_MODE] ['XCLASS'] ['ext/cal/model/iCalendar/class.tx_iCalendar_vevent.php']);
}
?>