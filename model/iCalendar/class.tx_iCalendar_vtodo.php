 ...
 */
class tx_iCalendar_vtodo extends tx_model_iCalendar {
	function getType() {
		return 'vTodo';
	}
...
if (defined ('TYPO3_MODE') && $TYPO3_CONF_VARS [TYPO3_MODE] ['XCLASS'] ['ext/cal/model/iCalendar/class.tx_iCalendar_vtodo.php']) {
	include_once ($TYPO3_CONF_VARS [TYPO3_MODE] ['XCLASS'] ['ext/cal/model/iCalendar/class.tx_iCalendar_vtodo.php']);
}
?>