...
class tx_cal_customtca {
	...
	function byDay($PA, $fobj) {
		...
		$out[] = $this->commonJS;
		$out[] = $html;
		$out[] = '<input type="hidden" name="data[tx_cal_event]['.$this->uid.'][byday]" id="data[tx_cal_event]['.$this->uid.'][byday]" value="'.$this->row['byday'].'" />';
	...
	function byMonthDay($PA, $fobj) {
		...
		$out[] = $this->commonJS;
		$out[] = $html;
		$out[] = '<input type="hidden" name="data[tx_cal_event]['.$this->uid.'][bymonthday]" id="data[tx_cal_event]['.$this->uid.'][bymonthday]" value="'.$this->row['bymonthday'].'" />';
	...
	function byMonth($PA, $fobj) {
		...
		$out[] = 	"var byMonth = new ByMonthUI('bymonth-container', 'data[tx_cal_event][".$this->uid."][bymonth]', 'row');";
		...
		$out[] = '</div>';	
		$out[] = '<input type="hidden" name="data[tx_cal_event]['.$this->uid.'][bymonth]" id="data[tx_cal_event]['.$this->uid.'][bymonth]" value="'.$this->row['bymonth'].'" />';
	...
	function byDay_checkbox() {
		$out[] = '<script type="text/javascript">';
		$out[] = 	"var byDay = new ByDayUI('byday-container', 'data[tx_cal_event][".$this->uid."][byday]', 'row');";
	...
	function byDay_select($row) {
		...
		$out[] = '<script type="text/javascript">';
		$out[] = 	"var byDay = new ByDayUI('byday-container', 'data[tx_cal_event][".$this->uid."][byday]', 'row', '".$row."');";
		$out[] = 	"Event.observe(window, 'load', function() { byDay.load(); });";
		$out[] = '</script>';
	...
	function byMonthDay_select($row) {
		...
		$out[] = '<script type="text/javascript">';
		$out[] = 	"var byMonthDay = new ByMonthDayUI('bymonthday-container', 'data[tx_cal_event][".$this->uid."][bymonthday]', 'row', '".$row."');";
