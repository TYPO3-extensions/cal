...
//*************************************************
				if($config['treeView'] AND $config['foreign_table']) {
					...
					$catres = $GLOBALS['TYPO3_DB']->exec_SELECTquery ('tx_cal_category.uid, tx_cal_category.title, tx_cal_category.calendar_id, tx_cal_category.parent_category', 'tx_cal_category','1=1'.$catWhere);
