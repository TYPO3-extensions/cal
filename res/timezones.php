...
$timezones = Array (
		...
		Array (
				'(GMT-03:00) Western Greenland Time',
				'WGT' 
		),
		Array (
				'(GMT-03:00) Miquelon',
		...
		Array (
				'(GMT+01:00) Western African Time',
				'WAT' 
		),
		Array (
		...
		Array (
				'(GMT+01:00) Eastern Greenland Time',
				'EGT' 
		),
		Array (
				'(GMT+01:00) Middle Europe Time',
				'MET' 
		),
		Array (
		...
		Array (
				'(GMT+02:00) Central African Time',
				'CAT' 
		),
		Array (
		...
		Array (
				'(GMT+05:00) Turkmenistan',
				'TMT' 
		),
		Array (
				'(GMT+05:00) Kirgizstan',
				'KGT' 
		),
		Array (
				'(GMT+05:00) Tajikistan',
				'TJT' 
		),
		Array (
				'(GMT+05:00) Pakistan',
		...
		Array (
				'(GMT+05:00) French Southern & Antarctic Lands',
				'TFT' 
		),
		Array (
				'(GMT+05:00) Maldives',
		...
		Array (
				'(GMT+06:00) Indian Ocean Territory',
				'IOT' 
		),
		Array (
				'(GMT+06:30) Myanmar',
		...
		Array (
				'(GMT+09:00) Central Standard Time',
				'CST' 
		),
		Array (
		...
		Array (
				'(GMT+10:30) Load Howe Standard Time',
				'LHST' 
		),
		Array (
				'(GMT+11:00) Magadan',
		...
		Array (
				'(GMT+12:00) Petropavlovsk-Kamchatski',
				'PETT' 
		),
		Array (
