...
class tx_cal_rights_service extends tx_cal_base_service {
	...
	function isAllowedToCreateCalendarOwner(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['allowedToCreateOwner.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarActivateFreeAndBusy(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['allowedToCreateActivateFreeAndBusy.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarFreeAndBusyUser(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['allowedToCreateFreeAndBusyUser.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarType(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['allowedToCreateType.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOnlyOwnCalendar(){
		return $this->checkRights($this->conf['rights.']['edit.']['calendar.']['allowedToEditOnlyOwnCalendar.']);
	}
	
	function isAllowedToEditPublicCalendar(){
		return $this->checkRights($this->conf['rights.']['edit.']['calendar.']['allowedToEditPublicCalendar.']);
	}
	...
	function isAllowedToEditCalendarType(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['allowedToEditType.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarOwner(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['allowedToEditOwner.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarActivateFreeAndBusy(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['allowedToEditActivateFreeAndBusy.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarFreeAndBusyUser(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['allowedToEditFreeAndBusyUser.']))
			return true;
		return false;
	}
	...
	function isAllowedToDeleteOnlyOwnCalendar(){
		return $this->checkRights($this->conf['rights.']['delete.']['calendar.']['allowedToDeleteOnlyOwnCalendar.']);
	}
	
	function isAllowedToDeletePublicCalendar(){
		return $this->checkRights($this->conf['rights.']['delete.']['calendar.']['allowedToDeletePublicCalendar.']);
	}
	...
	function isAllowedToCreateCategoryParent() {
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['allowedToCreateParent.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategorySharedUser() {
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['allowedToCreateSharedUser.']))
			return true;
		return false;		
	}
	...
	function isAllowedToEditOnlyOwnCategory(){
		return $this->checkRights($this->conf['rights.']['edit.']['category.']['allowedToEditOnlyOwnCategory.']);
	}
	
	function isAllowedToEditGeneralCategory(){
		return $this->checkRights($this->conf['rights.']['edit.']['calendar.']['allowedToEditGeneralCategory.']);
	}
	...
	function isAllowedToEditCategoryParent() {
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['allowedToEditParent.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategorySharedUser() {
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['allowedToEditSharedUser.']))
			return true;
		return false;		
	}
	...
	function isAllowedToDeleteOnlyOwnCategory(){
		return $this->checkRights($this->conf['rights.']['delete.']['category.']['allowedToDeleteOnlyOwnCategory.']);
	}
	
	function isAllowedToDeleteGeneralCategory(){
		return $this->checkRights($this->conf['rights.']['delete.']['category.']['allowedToDeleteGeneralCategory.']);
	}
	
	function isAllowedTo($type, $object, $field){
		$allowedTo = 'allowedTo'.ucwords($type);
		if($field=='') {
			/* @fixme	 Temporary fix to transform createEvent into createEvents */
			if($object == 'event') {
				$allowedTo .= ucwords(strtolower($object)).'s.';
			} else {
				$allowedTo .= ucwords(strtolower($object)).'.';
			}	
			return $this->checkRights($this->conf['rights.'][$type.'.'][$object.'.'][$allowedTo]);	 
		}
			
		$allowedTo .= ucwords(strtolower($field)).'.';
		if($this->checkRights($this->conf['rights.'][$type.'.'][$object.'.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.'][$type.'.'][$object.'.']['fields.'][$allowedTo])) {
			return true;
		}
