...
class tx_cal_rights_service extends tx_cal_base_service {
	...
	function tx_cal_rights_service(){
	...
	function isAllowedToCreateEventHidden(){
		...
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventCategory(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['category.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventCalendar(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['calendar_id.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventDateTime(){
		if($this->conf['rights.']['create.']['event.']['public'] && (
				$this->conf['rights.']['create.']['event.']['fields.']['startdate.']['public'] ||
				$this->conf['rights.']['create.']['event.']['fields.']['enddate.']['public'] ||
				$this->conf['rights.']['create.']['event.']['fields.']['starttime.']['public'] ||
				$this->conf['rights.']['create.']['event.']['fields.']['endtime.']['public']
				)){
			return true;
		}
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
			$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['startdate.']) ||
			$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['enddate.']) ||
			$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['starttime.']) ||
			$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['endtime.'])
			)
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventTitle(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventOrganizer(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['organizer.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventLocation(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['location.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventDescription(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['description.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventTeaser(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['teaser.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventRecurring(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['recurring.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventNotify(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['notify.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventException(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['exception.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateEventShared(){
		...
		if($this->checkRights($this->conf['rights.']['create.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['event.']['fields.']['shared.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventHidden(){
		...
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventCalendar(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['calendar.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventCategory(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['category.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventTitle(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventOrganizer(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['organizer.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventLocation(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['location.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventDescription(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['description.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventTeaser(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['teaser.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventRecurring(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['recurring.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventNotify(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['notify.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditEventException(){
		if($this->checkRights($this->conf['rights.']['edit.']['event.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['event.']['fields.']['exception.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationHidden(){
		...
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationTitle(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationDescription(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['description.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationName(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['name.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationStreet(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['street.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationZip(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['zip.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationCity(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['city.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationCountryZone(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['countryZone.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationCountry(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['country.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationPhone(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['phone.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationEmail(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['email.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationImage(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['image.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateLocationLink(){
		if($this->checkRights($this->conf['rights.']['create.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['location.']['fields.']['link.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationHidden(){
		...
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationTitle(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationDescription(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['description.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationName(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['name.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationStreet(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['street.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationZip(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['zip.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationCity(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['city.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationCountryZone(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['countryZone.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationCountry(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['country.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationPhone(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['phone.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationEmail(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['email.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationLogo(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['logo.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditLocationHomepage(){
		if($this->checkRights($this->conf['rights.']['edit.']['location.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['location.']['fields.']['homepage.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerHidden(){
		...
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerTitle(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerDescription(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['description.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerName(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['name.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerStreet(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['street.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerZip(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['zip.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerCity(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['city.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerPhone(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['phone.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerEmail(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['email.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerImage(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['image.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateOrganizerLink(){
		if($this->checkRights($this->conf['rights.']['create.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['organizer.']['fields.']['link.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerHidden(){
		...
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerTitle(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerDescription(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['description.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerName(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['name.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerStreet(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['street.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerZip(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['zip.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerCity(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['city.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerPhone(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['phone.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerEmail(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['email.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerLogo(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['logo.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditOrganizerHomepage(){
		if($this->checkRights($this->conf['rights.']['edit.']['organizer.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['organizer.']['fields.']['homepage.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarHidden(){
		...
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarTitle(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarOwner(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['owner.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarActivateFreeAndBusy(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['activateFreeAndBusy.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarFreeAndBusyUser(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['freeAndBusyUser.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCalendarType(){
		if($this->checkRights($this->conf['rights.']['create.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['calendar.']['fields.']['type.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarHidden(){
		...
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarType(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['type.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarTitle(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarOwner(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['owner.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarActivateFreeAndBusy(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['activateFreeAndBusy.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCalendarFreeAndBusyUser(){
		if($this->checkRights($this->conf['rights.']['edit.']['calendar.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['calendar.']['fields.']['freeAndBusyUser.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategoryHidden(){
		...
		$this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategoryTitle(){
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategoryHeaderStyle(){
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['headerstyle.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategoryBodyStyle(){
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['bodystyle.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategoryCalendar(){
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['calendar.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategoryParent() {
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['parent.']))
			return true;
		return false;
	}
	...
	function isAllowedToCreateCategorySharedUser() {
		if($this->checkRights($this->conf['rights.']['create.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['create.']['category.']['fields.']['sharedUser.']))
			return true;
		return false;		
	}
	...
	function isAllowedToEditCategoryHidden(){
		...
		$this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['hidden.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategoryTitle(){
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['title.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategoryHeaderstyle(){
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['headerstyle.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategoryBodystyle(){
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['bodystyle.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategoryCalendar(){
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		$this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['calendar.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategoryParent() {
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['parent.']))
			return true;
		return false;
	}
	...
	function isAllowedToEditCategorySharedUser() {
		if($this->checkRights($this->conf['rights.']['edit.']['category.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.']['edit.']['category.']['fields.']['sharedUser.']))
			return true;
		return false;		
	}
	...
	function isAllowedToConfigure(){
		return ($this->isLoggedIn() && $this->isViewEnabled('admin') && ($this->isCalAdmin() || 
			$this->isAllowedToCreateCalendar() ||
			$this->isAllowedToEditCalendar() ||
			$this->isAllowedToDeleteCalendar() ||
			$this->isAllowedToCreateCategory() ||
			$this->isAllowedToEditCategory() ||
			$this->isAllowedToDeleteCategory() ||
			$this->isAllowedTo('create','location') ||
			$this->isAllowedTo('edit','location') ||
			$this->isAllowedTo('delete','location') ||
			$this->isAllowedToCreateOrganizer() ||
			$this->isAllowedToEditOrganizer() ||
	...
	function isAllowedTo($type, $object, $field=''){
		...
		if(($this->conf['rights.'][$type.'.']['public'] && $this->conf['rights.'][$type.'.'][$object.'.']['fields.'][$field.'.']['public']) ||
			$this->checkRights($this->conf['rights.'][$type.'.'][$object.'.']['enableAllFields.']) ||
		   $this->checkRights($this->conf['rights.'][$type.'.'][$object.'.']['fields.'][$field.'.'])) {
			return true;
		}
	...
	function checkView($view){
		...
		if ($view == 'translation' && $this->rightsObj->isAllowedTo('create','translation') && $this->isViewEnabled($view)){
		}else
		if ($view == 'meeting' && $this->isViewEnabled($view)){
		}else
		if ($view == 'admin' && $this->rightsObj->isAllowedToConfigure()){
		} else
		if (($view == 'load_events' || $view == 'load_todos' || $view == 'load_calendars' || $view == 'load_categories' || $view == 'load_rights' || $view == 'load_locations' || $view == 'load_organizers' || $view == 'search_user_and_group') && $this->conf['view.']['enableAjax']) {
			// catch all allowed standard view types
		} else
		...
		if (($view == 'save_category' || $view == 'edit_category' || $view == 'confirm_category' || $view == 'delete_category' || $view == 'remove_category' || $view == 'create_category') 
				&& $this->rightsObj->isCalEditable() 
				&& (   $this->rightsObj->isAllowedToCreateCalendar() 
					|| $this->rightsObj->isAllowedToEditCategory()
					|| $this->rightsObj->isAllowedToDeleteCategory())) {
		} else
		if (($view == 'save_event' || $view == 'edit_event' || $view == 'confirm_event' || $view == 'delete_event' || $view == 'remove_event' || $view == 'create_event') 
				&& $this->rightsObj->isCalEditable() 
				&& (   $this->rightsObj->isAllowedToCreateEvent() 
					|| $this->rightsObj->isAllowedToEditEvent()
		...
		if (($view == 'save_location' || $view == 'confirm_location' || $view == 'create_location' || $view == 'edit_location' || $view == 'delete_location' || $view == 'remove_location')
				&& $this->rightsObj->isCalEditable() 
				&& (   $this->rightsObj->isAllowedToCreateLocations()
					|| $this->rightsObj->isAllowedToEditLocation()
					|| $this->rightsObj->isAllowedToDeleteLocation())) {
		// catch create_location view type and check all conditions
		} else
		if (($view == 'save_organizer' || $view == 'confirm_organizer' || $view == 'create_organizer' || $view == 'edit_organizer' || $view == 'delete_organizer' || $view == 'remove_organizer')
				&& $this->rightsObj->isCalEditable() 
				&& (   $this->rightsObj->isAllowedToCreateOrganizer()
					|| $this->rightsObj->isAllowedToEditOrganizer()
...
//		} else if ($this->isViewEnabled($view)){
		...
		if(count($this->conf['view.']['allowedViews'])==1){
			$view = $this->conf['view.']['allowedViews'][0];
			if(!in_array($this->conf['view.']['allowedViews'][0],array('event','organizer','location'))){
				$this->conf['uid'] = '';
	...
	/**
	 * Sets the default pages for saving calendars, events, etc. If the Typoscript
	...
	/**
	 * Sets a conf value if it is currently empty.  Helper function for setDefaultSaveToPage().
	 *
	 * @param		mixed		The conf value to be set.
