...
class tx_cal_rights_service extends tx_cal_base_service {
	...
	function checkView($view){
		...
		if (($view == 'load_events' || $view == 'load_todos' || $view == 'load_calendars' || $view == 'load_rights' || $view == 'load_locations' || $view == 'load_organizers' || $view == 'search_user_and_group') && $this->conf['view.']['enableAjax']) {
			// catch all allowed standard view types
		} else
