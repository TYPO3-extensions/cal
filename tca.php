...
$TCA['tx_cal_organizer'] = Array (
	...
	'types' => Array (
		'0' => Array('showitem' => 'name;;1;;2-2-2,description;;;richtext:rte_transform[mode=ts_images-ts_reglinks|imgpath=uploads/tx_cal/pics/], street, city, country, country_zone, zip, phone,email,image;;2;;;,imagecaption,link')
	),
	'palettes' => Array (
		'1' => Array('showitem' => 'hidden,l18n_parent,sys_language_uid,t3ver_label'),
