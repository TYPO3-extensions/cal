...
$TCA["tx_cal_event"] = Array (
	...
	"interface" => Array (
		"showRecordFieldList" => "hidden,category_id,title,start_date,start_time,end_date,end_time,organizer,location,description,image,imagecaption,freq,byday,bymonthday,bymonth,until,count,end,intrval,ex_freq, ex_byday, ex_bymonthday, ex_bymonth, ex_until,exception_cnt, shared_user_cnt"
	),
...
//				"internal_type" => "db",	
	...
	'types' => Array (
		...
		"1" => Array("showitem" => "type,title;;1;;,owner,activate_fnb,fnb_user_cnt,ext_url"),
		"2" => Array("showitem" => "type,title;;1;;,owner,activate_fnb,fnb_user_cnt,ics_file"),
	),
	'palettes' => Array (
