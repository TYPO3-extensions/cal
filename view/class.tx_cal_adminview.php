...
class tx_cal_adminview extends tx_cal_base_view {
	...
	function drawAdminPage() {
		...
		$createCalendarLink .= $this->controller->pi_linkTP_keepPIvars($this->controller->pi_getLL('l_create_calendar'), array ("lastview" => "admin", "view" => "create_calendar", "type" => "tx_cal_calendar"), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf["view."]["calendar."]["create_calendarViewPid"]);
		$GLOBALS['TSFE']->ATagParams = 'title="'.$this->controller->pi_getLL('l_create_category').'"';
		$createCategoryLink .= $this->controller->pi_linkTP_keepPIvars($this->controller->pi_getLL('l_create_category'), array ("lastview" => "admin", "view" => "create_category", "type" => "tx_cal_category"), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf["view."]["category."]["create_categoryViewPid"]);
		$GLOBALS['TSFE']->ATagParams = 'title="'.$this->controller->pi_getLL('l_create_organizer').'"';
		$createOrganizerLink .= $this->controller->pi_linkTP_keepPIvars($this->controller->pi_getLL('l_create_organizer'), array ("lastview" => "admin", "view" => "create_organizer"), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf["view."]["organizer."]["create_organizerViewPid"]);
		$GLOBALS['TSFE']->ATagParams = 'title="'.$this->controller->pi_getLL('l_create_location').'"';
		$createLocationLink .= $this->controller->pi_linkTP_keepPIvars($this->controller->pi_getLL('l_create_location'), array ("lastview" => "admin", "view" => "create_location"), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf["view."]["location."]["create_locationViewPid"]);
		$GLOBALS['TSFE']->ATagParams = 'title="'.$this->controller->pi_getLL('l_create_event').'"';
		$createEventLink .= $this->controller->pi_linkTP_keepPIvars($this->controller->pi_getLL('l_create_event'), array ("lastview" => "admin", "view" => "create_event"), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf["view."]["event."]["create_eventViewPid"]);
