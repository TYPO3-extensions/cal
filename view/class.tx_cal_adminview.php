...
class tx_cal_adminview extends tx_cal_base_view {
	...
	function drawAdminPage() {
		...
		if($this->rightsObj->isAllowedTo("create","calendar") && $this->rightsObj->isViewEnabled('create_calendar')){
			...
			$this->local_cObj->data['link'] = $this->controller->pi_linkTP_keepPIvars_url(array ('lastview' => $this->controller->extendLastView(), 'view' => 'create_calendar', 'type' => 'tx_cal_calendar'), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf['view.']['calendar.']['createCalendarViewPid']);
		...
		if($this->rightsObj->isAllowedTo("create","category") && $this->rightsObj->isViewEnabled('create_category')){
			...
			$this->local_cObj->data['link'] = $this->controller->pi_linkTP_keepPIvars_url(array ('lastview' => $this->controller->extendLastView(), 'view' => 'create_category', 'type' => 'tx_cal_category'), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf['view.']['category.']['createCategoryViewPid']);
		...
		if($this->rightsObj->isAllowedTo("create","organizer") && $this->rightsObj->isViewEnabled('create_organizer')){
			...
			$this->local_cObj->data['link'] = $this->controller->pi_linkTP_keepPIvars_url(array ('lastview' => $this->controller->extendLastView(), 'view' => 'create_organizer'), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf['view.']['organizer.']['createOrganizerViewPid']);
		...
		if($this->rightsObj->isAllowedTo("create","location") && $this->rightsObj->isViewEnabled('create_location')){
			...
			$this->local_cObj->data['link'] = $this->controller->pi_linkTP_keepPIvars_url(array ('lastview' => $this->controller->extendLastView(), 'view' => 'create_location'), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf['view.']['location.']['createLocationViewPid']);
		...
		if($this->rightsObj->isAllowedTo("create","event") && $this->rightsObj->isViewEnabled('create_event')){
			...
			$this->local_cObj->data['link'] = $this->controller->pi_linkTP_keepPIvars_url(array ('lastview' => $this->controller->extendLastView(), 'view' => 'create_location'), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf['view.']['location.']['createLocationViewPid']);
			$createEventLink .= $this->controller->pi_linkTP_keepPIvars_url(array ('lastview' => $this->controller->extendLastView(), 'view' => 'create_event'), $this->conf['cache'], $this->conf['clear_anyway'], $this->conf['view.']['event.']['createEventViewPid']);
			$showEventForm = true;
		}else{
			$rems['###CREATE_EVENT###'] = '';	
		}
