...
class tx_cal_adminview extends tx_cal_base_view {
	...
	function drawAdminPage() {
		...
		//CATEGORY
		$categoryArrays = $this->controller->modelObj->findAllCategories('cal_category_model','tx_cal_category',$this->conf['pidList']);
		...
		$eventArray = $this->controller->modelObj->findAll('cal_event_model','tx_cal_phpicalendar','event', $this->conf['pidList']);
