 ...
 */
class tx_cal_delete_calendar_view extends tx_cal_base_view {
	...
	function drawDeleteCalendar(&$object){
		...
		if ($page=="") {
			return "<h3>calendar: no confirm calendar template file found:</h3>".$this->conf["view."]["calendar."]["confirmCalendarTemplate"];
		}

		$languageArray = array();
		$form 	= $this->cObj->getSubpart($page, "###FORM_START###");
		$languageArray ['l_confirm_calendar'] = $this->controller->pi_getLL('l_delete_calendar');
