...
class tx_cal_delete_event_view extends tx_cal_base_view {
	...
	function drawDeleteEvent(&$event, $pidList ) {
		...
		$cal_user = '';
		$where = ' AND tx_cal_event.uid='.$event->getUid().' AND tx_cal_fe_user_category_mm.tablenames="fe_users" '.$this->cObj->enableFields('tx_cal_event');
		$orderBy = '';
		$groupBy = '';
		$limit = '';
...
//		}
		...
		$cal_notify_user = '';
		$where = ' AND tx_cal_event.uid='.$event->getUid().' AND tx_cal_fe_user_event_monitor_mm.tablenames="fe_users" '.$this->cObj->enableFields('tx_cal_event');
		$orderBy = '';
		$groupBy = '';
		$limit = '';
		...
		$where = ' AND tx_cal_event.uid='.$event->getUid().' AND tx_cal_fe_user_event_monitor_mm.tablenames="fe_groups" '.$this->cObj->enableFields('tx_cal_event');
