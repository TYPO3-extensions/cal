...
class tx_cal_listview extends tx_cal_base_view {
	...
	function drawList(&$master_array, $page='') {
		...
		if(stristr($this->conf["view"],'search') ){
			$starttime = ($this->controller->piVars['start_day']?intval($this->controller->piVars['start_day']):"19700101");
			$endtime = ($this->controller->piVars['end_day']?intval($this->controller->piVars['end_day']):"2050101");
