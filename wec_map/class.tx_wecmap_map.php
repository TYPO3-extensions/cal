...
require_once('class.tx_wecmap_map_google.php');
...
class tx_wecmap_map {
	...
	function addMarkerByAddress($street, $city, $state, $zip, $country, $title='', $description='') {		
		...
		/* Geocode the address */
		include_once(t3lib_extMgm::extPath('cal').'wec_map/class.tx_wecmap_cache.php');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cal/wec_map/class.tx_wecmap_map.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cal/wec_map/class.tx_wecmap_map.php']);
}
