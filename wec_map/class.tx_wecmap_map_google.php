...
require_once(t3lib_extMgm::extPath('cal').'wec_map/class.tx_wecmap_map.php');
...
class tx_wecmap_map_google extends tx_wecmap_map {
	...
	function js_icon() {
		if (TYPO3_MODE=='BE')	{
			$path = t3lib_extMgm::extRelPath('cal');
		} else {
			$path = t3lib_extMgm::siteRelPath('cal');
		}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cal/wec_map/class.tx_wecmap_map_google.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cal/wec_map/class.tx_wecmap_map_google.php']);
}
